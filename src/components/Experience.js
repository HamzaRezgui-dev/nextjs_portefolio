        ...
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative">
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4">
                    <Details position="Software Engineer Intern" company="Fondative" time="February 2024 - July 2024"
                             address="Tunis"
                    ...
                    <Details position="Part time Fullstack Developer" company="Appaxis Innovations"
                    ...
                    <Details position="Frontend Developer Intern" company="Terrakodo SUARL"
                    ...
                    <Details position="Fullstack Developer Intern" company="Amen Bank"
