                ...
                <main className="flex w-full flex-col items-center justify-center dark:text-light">
                    <Layout className="pt-16">
                        ...
                        <div className="grid w-full grid-cols-9 gap-16">
                            ...
                            <div
                                className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light dark:bg-dark dark:border-light p-8">
                                <div
                                    className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light "/>
                                <Image src={profilePic} alt="hamza_pic" className="w-full h-auto rounded-3xl" priority
